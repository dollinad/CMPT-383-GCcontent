...
import { IGetItemPropsOptions, IUseSelectionState, IUseSelectionProps } from '@zendeskgarden/container-selection';
...
export declare function useTabs<Item = any>({ vertical, idPrefix, ...options }?: IUseTabsProps<Item>): IUseTabsReturnValue<Item>;
export {};
